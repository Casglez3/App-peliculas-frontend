...
import { peliculasMejorValoradas } from '../../api-calls/appTheMovieDB';


const PeliculasMejorValoradas = () => {
  ...
  useEffect(() => {
    const obtenerPeliculas = async () => {
      try {
        const data = await peliculasMejorValoradas(paginaActual);
  ...
  return (
    <div className='titulo-estado'>
      <h1 style={{color: 'white', textShadow: '0 0 10px black'}}>Películas mejor valoradas</h1>
...
export default PeliculasMejorValoradas;
